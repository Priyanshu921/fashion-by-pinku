  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 px-6 text-center relative">
        ...
        <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl mb-6 tracking-tight relative z-10 drop-shadow-2xl text-white">
          Elegance, <br />
          <span className="text-brand-pink font-serif italic font-normal tracking-wide">
            Redefined.
          </span>
        </h1>
        <p className="text-white/70 max-w-xl mx-auto text-lg md:text-xl font-light mb-12 relative z-10 leading-relaxed font-mono">
      ...
      {availableCategories.length > 0 && (
        <section ref={productGridRef} className="max-w-7xl mx-auto px-6 mb-16 relative z-10">
          <div className="flex justify-center items-center gap-4 flex-wrap">
            <button
              onClick={() => setActiveCategory('all')}
              className={`cursor-pointer px-6 py-2 rounded-full text-sm font-semibold uppercase tracking-wider transition-all duration-300 border ${
                activeCategory === 'all' 
      ...
      <section className="max-w-7xl mx-auto px-6 pb-32">
        {!products ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8 relative z-0">
